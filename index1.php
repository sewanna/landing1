...
<html>
    ...
    <body>
      <div class="side-menu" style="display:none"> 
        ...
        <?php require(__DIR__ . "/inc/header.php"); ?> <!-- __DIR__. - directory, podaje ścieżke >
        ...
        <script type="text/javascript" src="./vendor/jquery/jquery-3.5.1.js"></script>
        <script type="text/javascript" src="./vendor/jquery/jquery.jpanelmenu.js"></script>
    ...
    direction: 'right', /* menu on the right site, wyswietlenie menu po prawej stronie*/

        });

        jPM.on();
        $(".side-menu a").click (function(){
            jPM.close(); /* closed menu, zamkniecie menu */
        }
        )
    });
